    ...
    <section className="page-section">
      ...
      {!loading && !error && activeProject && (
        <SectionCard
          ...
          description="`serviceRequests` permanece em bot-whatsapp-ai-d10ef. A ação de confirmação aprova e dispara a integração outbound para appointments em agendamento-ai-9fbfb, sem transformar o Core na fonte de verdade do agendamento."
          aside={
